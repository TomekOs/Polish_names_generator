...
1. List of Polish first names was scrapped from Wikipedia site.
2. Each name was assigned its category of origin and gender.
3. Based on data from step LSTM recurrent neural network was trained. Trained model is character-level _language models_ e.g. in each time step each model generates probability of the next character.
